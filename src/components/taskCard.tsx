...
const TaskCard = ({ task, deleteTask, updateTask }: Props) => {
    ...
    if (isDragging) {
        return <div ref={setNodeRef} style={style} className=' opacity-50 bg-mainBackgroundColor p-2 h-[100px] min-h-[100px] items-center flex text-left rounded-xl hover:ring-2 hover:ring-inset border-rose-400 cursor-grab relative'/>
    }
    ...
    if (editMode) {
        return <div
            ...
            h-[90%]
            w-full
            resize-none border-none rounded bg-transparent text-white focus:outline-none
            '
                value={task.content}
                autoFocus
